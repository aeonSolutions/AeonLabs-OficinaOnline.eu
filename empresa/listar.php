	...
	<!-- Header -->
		<header>
			<div class="sixteen columns">
				<div class="logo"> <!-- Logo -->
					<a href="http://www.oficinaonline.eu"><img src="../images/logo.png" alt="yourlogo"></a>
				</div>
				<!-- End Logo -->
				...
				<nav id="navigation"> <!-- Nav -->
					<ul>
					  <li><a href="#features">O que oferecemos</a></li>
						<li><a href="#tour">Quem Somos</a></li>
...
<div class="container extra main">
	...
	<section id="tour">
		...
		<div class="grid">
				...
				<p class="lead">
						Neste momento não existe atendimento telefónico disponivel. <br/>Tente mais tarde.
	...
	<footer id="footer">
		...
		<div class="container">
			<div class="six columns copyrights"> <!-- Copyrights -->
				<p> 
				Website desenvolvido por <a href="http://www.aeonlabs.de">Aeonlabs</a>
				<br> 2016 Oficina Online © onde se aplicar. A Base de Dados é disponibilizada no formato <a href="http://www.opendatacommons.org/licenses/pddl/1.0/">OPEN DATA PDDL V1.0</a> 
				</p>
			</div>
			<!-- End Copyrights -->
